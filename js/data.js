...
var MIN_LOG = Math.log10(1e-15); // ~0.01 m — true-scale rendering for all objects including spacecraft
...
var effects = { twinkling: true, warpStreaks: true, glowIntensity: 1.0, flowLines: true, ambientParticles: true, orbits: true, overlayStyle: 'albedo', orbitalPlanes: true, occlusion: false, galacticParticles: true, missionTrajectories: true };
...
var properMotionData = {
  ...
  'Rigel':               { pmRA: 1.31,     pmDec: 0.50,    rv: 17.8 },
  'Deneb':               { pmRA: 1.99,     pmDec: 1.95,    rv: -4.5 },
  ...
  'Phecda':              { pmRA: 107.68,   pmDec: 11.01,   rv: -12.6 },
  'Megrez':              { pmRA: 104.11,   pmDec: 7.30,    rv: -20.2 },
  'Alioth':              { pmRA: 111.74,   pmDec: -8.99,   rv: -9.3 },
  'Mizar':               { pmRA: 119.01,   pmDec: -25.97,  rv: -6.3 },
...
var galaxyMotion = {
  ...
  'Triangulum (M33)':         { approach: 0.00254 },          // 44 km/s toward MW
...
var regions = [
  ...
  { name: "Andromeda (disk)", cx: 1.41 * MLY, cy: 2.11 * MLY, rx: 110000, ry: 60000,
...
var objects = [
  ...
  { name: "Mercury", x: 0.39 * AU_IN_LY, y: -0.22 * AU_IN_LY, dist: 0.39 * AU_IN_LY, radius: 1.5, color: "#b5a08a", glow: "#b5a08a33",
    ...
    facts: [["Distance from Sun", "0.39 AU (3.2 light-min)"], ["Orbital period", "88 days"], ["Surface temp", "-180 to 430 \u00b0C"]],
  ...
  { name: "Ceres", x: 2.77 * AU_IN_LY, y: 0, dist: 2.77 * AU_IN_LY, radius: 0.8, color: "#aaa08a", glow: "#aaa08a22",
    ...
    facts: [["Distance from Sun", "2.77 AU (23 light-min)"], ["Orbital period", "4.6 years"], ["Diameter", "940 km"]],
  ...
  { name: "TRAPPIST-1 System", x: -30, y: -25, dist: 40.66, ra: 346.62, dec: -5.04, radius: 2, color: "#cc8866", glow: "#cc886644",
    type: "7-planet system (3 in habitable zone)", category: "stellar", visRange: [8, 200],
    facts: [["Distance", "40.66 light-years"], ["Planets", "7 rocky (b through h)"], ["Habitable zone", "e, f, g"], ["Star", "Ultra-cool red dwarf"]],
  ...
  { name: "HD 209458 b", x: -100, y: 120, dist: 157, radius: 2, color: "#ffaa55", glow: "#ffaa5544",
    type: "Hot Jupiter (evaporating)", category: "stellar", visRange: [20, 800],
    facts: [["Distance", "157 light-years"], ["Nickname", "Osiris"], ["Orbital period", "3.52 days"], ["Discovery", "First transiting exoplanet (1999)"]],
  ...
  { name: "WASP-12b", x: -950, y: 1050, dist: 1347, radius: 2, color: "#ff6633", glow: "#ff663344",
    type: "Ultra-hot Jupiter (doomed)", category: "stellar", visRange: [80, 12000],
    facts: [["Distance", "1,347 light-years"], ["Surface temp", "~2,600\u00b0C"], ["Orbital period", "1.09 days"], ["Fate", "Being consumed by its star"]],
  ...
  { name: "Ross 154", x: 7.0, y: 5.5, dist: 9.69, ra: 282.46, dec: -23.83, radius: 1.2, color: "#cc5533", glow: "#cc553322",
  ...
  { name: "Aldebaran", x: 40, y: -50, dist: 67, ra: 68.98, dec: 16.51, radius: 3, color: "#ff8844", glow: "#ff884433",
    type: "Red giant (K5III)", category: "stellar", visRange: [20, 300],
    facts: [["Distance", "67 light-years"], ["Diameter", "44x Sun"], ["Constellation", "Taurus (the eye)"]],
  ...
  { name: "Canopus", x: 150, y: -270, dist: 310, ra: 95.99, dec: -52.70, radius: 3.5, color: "#ffffcc", glow: "#ffffcc44",
    ...
    facts: [["Distance", "310 light-years"], ["Luminosity", "16,600 L\u2609"], ["Rank", "2nd brightest star"]],
    desc: "The 2nd brightest star in Earth's sky. Used for spacecraft navigation." },
  { name: "Polaris", x: 200, y: 380, dist: 446.5, ra: 37.95, dec: 89.26, radius: 3, color: "#ffeedd", glow: "#ffeedd44",
    type: "Supergiant (F7Ib)", category: "stellar", visRange: [80, 15000],
    facts: [["Distance", "446.5 light-years"], ["Type", "Cepheid variable (triple system)"], ["Role", "Current North Star"]],
  ...
  { name: "Betelgeuse", x: 20, y: -380, dist: 548, ra: 88.79, dec: 7.41, radius: 5, color: "#ff6633", glow: "#ff663355",
    type: "Red supergiant (M2Iab)", category: "stellar", visRange: [50, 15000], constellation: "orion", physRadius: 5.15e-5,
    facts: [["Distance", "548 light-years"], ["Diameter", "640-764x Sun"], ["Fate", "Supernova within 100,000 yr"]],
    desc: "A red supergiant so immense it would engulf Mars and reach the asteroid belt. Will explode as a supernova." },
  { name: "Bellatrix", x: 230, y: -400, dist: 250, ra: 81.28, dec: 6.35, radius: 3, color: "#99aaff", glow: "#99aaff44",
    ...
    facts: [["Distance", "250 light-years"], ["Luminosity", "7,410 L\u2609"], ["Name meaning", "'Female warrior' in Latin"]],
  ...
  { name: "Alnilam", x: 120, y: -555, dist: 1250, ra: 84.05, dec: -1.20, radius: 3, color: "#bbccff", glow: "#bbccff55",
    type: "Blue supergiant (B0Ia)", category: "stellar", visRange: [50, 10000], constellation: "orion",
    facts: [["Distance", "~1,250 light-years"], ["Luminosity", "275,000 L\u2609"], ["Belt position", "Center belt star (brightest)"]],
  ...
  { name: "Dschubba", x: -220, y: 280, dist: 443, ra: 240.08, dec: -22.62, radius: 2.5, color: "#aabbff", glow: "#aabbff33",
    type: "Subgiant (B0.3IV)", category: "stellar", visRange: [50, 5000], constellation: "scorpius",
    facts: [["Distance", "~443 light-years"], ["Name", "\u03b4 Scorpii"], ["Feature", "Be star with episodic brightening"]],
    desc: "The forehead of the Scorpion. A Be star that occasionally ejects disks of gas, causing dramatic brightness changes." },
  { name: "Sargas", x: -380, y: 540, dist: 329, ra: 264.33, dec: -42.99, radius: 2.5, color: "#ffddaa", glow: "#ffddaa33",
    type: "Giant (F1II)", category: "stellar", visRange: [50, 5000], constellation: "scorpius",
    facts: [["Distance", "~329 light-years"], ["Name", "\u03b8 Scorpii"], ["Luminosity", "~1,800 L\u2609"]],
  ...
  { name: "Megrez", x: 410, y: 340, dist: 80.5, ra: 183.86, dec: 57.03, radius: 1.8, color: "#ddeeff", glow: "#ddeeff22",
    type: "Star (A3V)", category: "stellar", visRange: [30, 5000], constellation: "bigdipper",
    facts: [["Distance", "80.5 light-years"], ["Name", "\u03b4 Ursae Majoris"], ["Note", "Faintest Dipper star"]],
  ...
  { name: "Mizar", x: 530, y: 270, dist: 82.9, ra: 200.98, dec: 54.93, radius: 2.5, color: "#ddeeff", glow: "#ddeeff33",
    type: "Sextuple star system (A2V)", category: "stellar", visRange: [30, 5000], constellation: "bigdipper",
    facts: [["Distance", "82.9 light-years"], ["Companion", "Alcor (visual double)"], ["System", "Actually 6 stars"]],
  ...
  // ── Crux / Southern Cross ──
  { name: "Acrux", x: -420, y: -310, dist: 348, ra: 186.65, dec: -63.10, radius: 3, color: "#aabbff", glow: "#aabbff44",
    type: "Triple star system (B0.5IV)", category: "stellar", visRange: [50, 5000], constellation: "crux",
    facts: [["Distance", "348 light-years"], ["Name", "\u03b1 Crucis"], ["System", "Triple star"], ["Use", "Points toward south celestial pole"]],
  ...
  { name: "Segin", x: 630, y: -130, dist: 470, ra: 28.60, dec: 63.67, radius: 2, color: "#bbccff", glow: "#bbccff33",
    type: "Main sequence (B3V)", category: "stellar", visRange: [50, 5000], constellation: "cassiopeia",
    facts: [["Distance", "470 light-years"], ["Name", "\u03b5 Cassiopeiae"], ["Cluster", "Near open cluster NGC 146"]],
  ...
  { name: "Ring Nebula", x: 1500, y: -1800, dist: 2570, radius: 4, color: "#55ccff", glow: "#55ccff33",
    type: "Planetary nebula", category: "nebula", visRange: [200, 50000],
    facts: [["Distance", "~2,570 light-years"], ["Diameter", "~1 ly (ring)"], ["Constellation", "Lyra"]],
  ...
  { name: "SGR 1806-20", x: -24000, y: 2000, dist: 42000, radius: 3, color: "#ff44aa", glow: "#ff44aa55",
    type: "Magnetar", category: "exotic", visRange: [500, 200000],
    facts: [["Distance", "~42,000 light-years"], ["2004 flare", "Altered Earth's ionosphere"], ["Magnetic field", "~10^15 x Earth's"]],
    desc: "The most powerful magnetic object known. Its 2004 flare affected Earth from 42,000 ly away." },
  ...
  { name: "SN 1987A", x: 72000, y: -143000, dist: 168000, radius: 5, color: "#ff8855", glow: "#ff885566",
  ...
  // Clusters
  { name: "47 Tucanae", x: 5000, y: -12000, dist: 14500, radius: 4, color: "#ffcc88", glow: "#ffcc8833",
  ...
  { name: "Omega Centauri", x: -8000, y: -13000, dist: 17000, radius: 5, color: "#ffdd99", glow: "#ffdd9944",
  ...
  { name: "Large Magellanic Cloud", x: 70000, y: -145000, dist: 163000, radius: 7, color: "#88aadd", glow: "#88aadd44",
    type: "Irregular dwarf galaxy", category: "local",
    facts: [["Distance", "~163,000 ly"], ["Visible", "Southern sky, naked eye"]],
  ...
  { name: "Andromeda (M31)", x: 1.41 * MLY, y: 2.11 * MLY, dist: 2.537 * MLY, radius: 14, color: "#bbaaee", glow: "#bbaaee55",
  ...
  { name: "Triangulum (M33)", x: 1.16 * MLY, y: 2.47 * MLY, dist: 2.73 * MLY, radius: 8, color: "#99aadd", glow: "#99aadd44",
  ...
  { name: "NGC 185", x: 1.05 * MLY, y: 1.76 * MLY, dist: 2.05 * MLY, radius: 3, color: "#8888aa", glow: "#8888aa22",
    type: "Dwarf spheroidal", category: "local",
    facts: [["Distance", "~2.05 Mly"]],
    desc: "An Andromeda satellite with recent star formation." },
  { name: "IC 10", x: 1.40 * MLY, y: 1.70 * MLY, dist: 2.2 * MLY, radius: 3, color: "#7799bb", glow: "#7799bb22",
  ...
  { name: "V1 (Hubble's Cepheid)", x: 1.41 * MLY - 20000, y: 2.11 * MLY + 15000, dist: 2.537 * MLY, radius: 2, color: "#ffeebb", glow: "#ffeebb44",
  ...
  { name: "V2 (Andromeda Cepheid)", x: 1.41 * MLY + 30000, y: 2.11 * MLY - 25000, dist: 2.537 * MLY, radius: 1.8, color: "#ffeebb", glow: "#ffeebb33",
    type: "Cepheid variable in M31", category: "stellar", visRange: [300000, 8 * MLY],
  ...
  { name: "V15 (Andromeda Cepheid)", x: 1.41 * MLY - 45000, y: 2.11 * MLY - 40000, dist: 2.537 * MLY, radius: 1.5, color: "#ffeebb", glow: "#ffeebb22",
    type: "Cepheid variable in M31", category: "stellar", visRange: [300000, 8 * MLY],
  ...
  { name: "NGC 1300", x: 25 * MLY, y: -57 * MLY, dist: 69 * MLY, radius: 4, color: "#aabbee", glow: "#aabbee33",
    type: "Barred spiral galaxy (SBbc)", category: "cosmic",
    facts: [["Distance", "~69 Mly"], ["Constellation", "Eridanus"], ["Feature", "Textbook example of barred spiral structure"]],
...
var glossaryData = [
  ...
  { name: "Betelgeuse", cat: "Stars", color: "#ff6633", short: "Dying red supergiant", long: "640-764 times the Sun's diameter -- if placed at our solar system's center, its surface would engulf Mars and reach the asteroid belt. Betelgeuse will explode as a supernova in the next 100,000 years. When it does, it will be visible in daylight for weeks." },
  ...
  { name: "Magnetars", cat: "Extreme Phenomena", color: "#ff44aa", short: "Universe's strongest magnets", long: "SGR 1806-20 released a gamma-ray burst in 2004 that affected Earth's ionosphere from 42,000 light-years away. Their magnetic fields are a quadrillion times Earth's." },
  ...
  { name: "Mercury", cat: "Solar System", color: "#b5a08a", short: "Closest to the Sun", long: "The smallest planet in the solar system and the closest to the Sun, orbiting at just 0.39 AU. Mercury experiences extreme temperature swings from -180 to 430 degrees Celsius between its long nights and scorching days. Its year lasts only 88 Earth days, yet a single day-night cycle takes 176 Earth days." },
  ...
  { name: "Mars", cat: "Solar System", color: "#cc6644", short: "The Red Planet", long: "Home to Olympus Mons, the tallest volcano in the solar system at 21 km, and Valles Marineris, a canyon system stretching 4,000 km. Evidence of ancient river valleys and lake beds suggests Mars once had liquid water on its surface. It remains the prime target for human exploration beyond the Moon." },
  { name: "Ceres", cat: "Solar System", color: "#aaa08a", short: "Queen of the asteroid belt", long: "The largest object in the asteroid belt at 940 km across. Discovered in 1801, reclassified as a dwarf planet in 2006. Contains roughly a third of the belt's total mass. NASA's Dawn mission revealed bright salt deposits in Occator crater and evidence of cryovolcanic activity hinting at a subsurface ocean of briny water." },
  ...
  { name: "Large Magellanic Cloud", cat: "Galaxies & Clusters", color: "#88aadd", short: "Milky Way's largest satellite", long: "An irregular dwarf galaxy 163,000 light-years away, easily visible to the naked eye from the Southern Hemisphere. It contains the Tarantula Nebula, the most active star-forming region in the Local Group, and played a key role in the discovery of the period-luminosity relationship for Cepheid variables." },
  ...
  { name: "NGC 1300", cat: "Galaxies & Clusters", color: "#ccaa88", short: "Textbook barred spiral", long: "Considered the prototypical barred spiral galaxy at 69 million light-years in the constellation Eridanus. Its prominent central bar channels gas inward, fueling star formation in a ring around the core. NGC 1300 is the classic example used in textbooks to illustrate barred spiral structure." },
  ...
  { name: "Alnilam", cat: "Stars", color: "#bbccff", short: "Belt's center -- twice as far", long: "The center and brightest star of Orion's Belt, blazing at 275,000 times the Sun's luminosity from 1,250 light-years away. It is nearly twice as distant as its belt companions Mintaka and Alnitak, proving that the three 'aligned' stars are not physically associated -- they just happen to line up from Earth's viewpoint." },
...
var tourDefs = {
  ...
  starlovers: {
    ...
    steps: [
      ...
      { vr: 350, target: "Betelgeuse", title: "Betelgeuse \u2014 The Dying Giant", body: "A red supergiant so immense that if it replaced our Sun, its surface would reach past Mars to the asteroid belt. Betelgeuse will explode as a supernova, perhaps tomorrow, perhaps in 100,000 years. When it does, it will be visible in daylight.", scale: "548 ly from Earth", dwell: 12000 },
  ...
  extreme: {
    ...
    steps: [
      ...
      { vr: 25000, target: "SGR 1806-20", title: "SGR 1806-20 \u2014 The Magnetar", body: "The most powerful magnetic object known. In 2004, it released a gamma-ray flare so intense it briefly altered Earth's ionosphere \u2014 from 42,000 light-years away. Its magnetic field is a quadrillion times Earth's.", scale: "42,000 ly from Earth", dwell: 12000 },
  ...
  lifecycle: {
    ...
    steps: [
      ...
      { vr: 350, target: "Betelgeuse", title: "A Star Ages", body: "When a massive star exhausts its hydrogen, it swells into a red supergiant. Betelgeuse has expanded to 640-764 times the Sun's diameter \u2014 if placed at our Sun's position, it would swallow Mars. Its core is desperately fusing heavier elements: helium, carbon, oxygen, silicon. When it reaches iron, the end comes.", scale: "548 ly from Earth", dwell: 14000 },
  ...
  constellations: {
    ...
    steps: [
      { sky3d: { viewFrom: "earth", lookAt: "orion" }, title: "Orion from Home", body: "This is Orion as you see it on a clear winter night \u2014 the Hunter's familiar shape traced across the sky. Seven bright stars that look flat, as if painted on a dome. But Bellatrix is 250 light-years away while the belt stars are at 1,200\u20131,250 ly. The constellation is a corridor, not a picture.", scale: "3D Sky View", dwell: 12000 },
      { sky3d: { viewFrom: "trappist", lookAt: "orion" }, title: "Orion from TRAPPIST-1", body: "Travel 39 light-years to the TRAPPIST-1 system. Watch what happens to the Hunter. Bellatrix, the nearest bright star at 250 ly, lurches sideways \u2014 shifting dramatically. But the distant belt at 1,200\u20131,250 ly barely flickers. The proud symmetry dissolves. One shoulder flings wide while the other holds fast. A TRAPPIST-1 astronomer would see a different picture entirely.", scale: "39 ly from Earth", dwell: 14000 },
      { sky3d: { viewFrom: "betelgeuse", lookAt: "sol" }, title: "From Betelgeuse, Looking Home", body: "Now stand on the Hunter's shoulder, 548 light-years from Earth. Look back toward Sol. Can you find it? Our Sun is a faint point lost among thousands of equally dim stars. From here, Earth's constellations are meaningless \u2014 the entire sky is rearranged. The stars we connected into pictures are scattered across space, and we are inside the pattern now.", scale: "548 ly from Earth", dwell: 12000 },
  ...
  monsters: {
    ...
    steps: [
      { vr: 350, target: "Betelgeuse", title: "The Giant Star", body: "640-764 times the Sun's diameter. If Betelgeuse replaced our Sun, its surface would engulf Mars and reach the asteroid belt. Despite its immensity, it's a dying star, burning through its remaining fuel at a furious rate. It will explode as a supernova within 100,000 years, briefly visible in daylight from Earth.", scale: "548 ly from Earth", dwell: 12000 },
      ...
      { vr: 25000, target: "SGR 1806-20", title: "The Ultimate Magnet", body: "The most powerful magnetic object in the known universe. In 2004, this magnetar released a gamma-ray flare so intense it altered Earth's ionosphere \u2014 from 42,000 light-years away. Its magnetic field is a quadrillion times Earth's. If it were halfway to the Moon, it would erase every credit card on Earth.", scale: "42,000 ly from Earth", dwell: 12000 },
...
var refDistances = [
  ...
  { name: "Sun \u2192 Betelgeuse", dist: 548, color: "#ff8855" },
